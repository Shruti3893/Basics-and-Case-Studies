...
# Data Set : Book 
book<-read.csv("C://Users//Lenovo//Desktop//ExcelR//Assignments//Association Rules//book.csv")
View(book)
class(book)
str(book)
summary(book)
...
G1<-read.csv("C://Users//Lenovo//Desktop//ExcelR//Assignments//Association Rules//groceries.csv")
View(G1)
str(G1)
summary(G1)
var(G1)
...
my_movies<-read.csv("C://Users//Lenovo//Desktop//ExcelR//Assignments//Association Rules//my_movies.csv")
View(my_movies)
class(my_movies)
str(my_movies)
summary(my_movies)
